...
export const indianStatesData = {
  "andhra-pradesh": {
    ...
    heroImage:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6hSPN0fVcC4azFijLLimM0qIjOjzfUfNRTS6UoeazScZGShqkhYs9ZQQ&s=10",
    description:
      "Home to scenic coastlines along the Bay of Bengal, ancient Buddhist sites, and rich spiritual heritage, Andhra Pradesh offers a perfect mix of pilgrimage centers and pristine beaches.",
    places: [
      {
  ...
  "arunachal-pradesh": {
    ...
    description:
      "India's easternmost frontier is a pristine sanctuary boasting snow-capped Himalayan peaks, deep verdant valleys, orchid forests, and ancient monasteries.",
    places: [
      {
  ...
  assam: {
    ...
    description:
      "Famous worldwide for its premium black tea estates, vibrant Bihu culture, silk weaving, and incredible biodiversity along the Brahmaputra valley.",
    places: [
      {
  ...
  bihar: {
    title: "Bihar",
    heroImage:
      "https://images.unsplash.com/photo-1612438214708-f428a707dd4e?auto=format&fit=crop&w=1920&q=80",
    description:
      "Step into the ultimate epicenter of spiritual enlightenment and historic educational empires, where Buddhism and Jainism found their roots.",
    places: [
      {
        name: "Bodh Gaya",
  ...
  chhattisgarh: {
    title: "Chhattisgarh",
    heroImage:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/76/98/71/the-falls-from-a-distance.jpg?w=1000&h=-1&s=1",
    description:
      "An offbeat nature-lover's paradise covered in thick forests, cascading waterfalls, ancient carved temples, and unique tribal craft heritages.",
    places: [
      {
  ...
  goa: {
    ...
    description:
      "Experience India's pocket paradise, blending golden Mediterranean beach culture, vibrant nightlife, historical churches, and spicy coastal cuisines.",
    places: [
      {
        name: "Calangute & Baga",
  ...
  gujarat: {
    ...
    description:
      "A culturally rich state offering vast salt deserts, historic architectural stepwells, Asiatic lion sanctuaries, and legendary textile marketplaces.",
    places: [
      {
        name: "Rann of Kutch",
  ...
  haryana: {
    ...
    description:
      "The land of rich agricultural traditions, ancient Vedic battlegrounds, and sprawling ultra-modern futuristic business cyber cities.",
    places: [
      {
  ...
  "himachal-pradesh": {
    ...
    description:
      "A mountain lover's dream destination filled with towering snow peaks, alpine pine forests, roaring river valleys, and action adventure sports.",
    places: [
      {
  ...
  "jammu-kashmir": {
    title: "Jammu & Kashmir",
    heroImage:
      "https://www.tourmyindia.com/states/jammu-kashmir/image/dal-lake-s1.jpg",
    description:
      "Widely regarded as Paradise on Earth, featuring mesmerizing snow peaks, deep valleys, pristine alpine lakes, and signature cozy wooden houseboats.",
    places: [
      {
  ...
  jharkhand: {
    ...
    description:
      "Rich in mineral wealth, dense woodlands, sacred hill temples, and hidden mountain waterfalls, Jharkhand is a paradise for eco-tourism.",
    places: [
      {
  ...
  karnataka: {
    title: "Karnataka",
    heroImage:
      "https://hblimg.mmtcdn.com/content/hubble/img/maingalleryimgs/mmt/activities/m_Badami_1_l_667_1000.jpg",
    description:
      "An incredible state offering high-tech modern metropolises, UNESCO world heritage ruins, aromatic spice hills, and coastal beaches.",
    places: [
      {
        name: "Hampi Ruins",
  ...
  kerala: {
    title: "Kerala",
    heroImage:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/13/5e/59/d4/alleppey-backwater-tour.jpg?w=800&h=-1&s=1",
    description:
      "Discover a serene tropical paradise stitched with emerald backwaters, sweeping tea gardens, spice plantations, and pristine palm-lined coastlines.",
    places: [
      {
  ...
  "madhya-pradesh": {
    ...
    heroImage:
      "https://images.unsplash.com/photo-1599940824399-b87987ceb72a?auto=format&fit=crop&w=1920&q=80",
    description:
      "Located right in central India, this destination boasts spectacular wildlife reserves, historic fortresses, and world-class architectural stone carvings.",
    places: [
      {
  ...
  maharashtra: {
    title: "Maharashtra",
    heroImage:
      "https://images.unsplash.com/photo-1562158147-f8d6fbcd76f8?auto=format&fit=crop&w=1920&q=80",
    description:
      "A powerhouse state featuring dynamic metropolitan business centers, ancient rock-cut cave monuments, historical hilltop forts, and serene coastlines.",
    places: [
      {
        name: "Mumbai City",
  ...
  manipur: {
    title: "Manipur",
    heroImage:
      "https://images.unsplash.com/photo-1618083707368-b3823daa2726?auto=format&fit=crop&w=1920&q=80",
    description:
      "A gorgeous northeastern paradise surrounded by blue hills, unique floating lake eco-systems, and rich, graceful classical dance traditions.",
    places: [
      {
        name: "Loktak Lake",
  ...
  meghalaya: {
    ...
    description:
      "A mist-covered playground in the clouds, globally celebrated for its rain-soaked green hills, massive underground cave systems, and bio-engineered root bridges.",
    places: [
      {
  ...
  mizoram: {
    ...
    description:
      "Perched along rolling ridges, Mizoram offers rich bamboo forest trails, dramatic valleys, and vibrant cultural bamboo dance traditions.",
    places: [
      {
        name: "Aizawl Ridges",
  ...
  nagaland: {
    title: "Nagaland",
    heroImage:
      "https://hornbillfestival.com/wp-content/uploads/2025/11/pexels-anusree-gs-44418848-30952346-1024x833.jpg",
    description:
      "A culturally rich mountain state home to various indigenous tribes, green valleys, and the world-famous annual Hornbill Festival.",
    places: [
      {
        name: "Kohima Hills",
  ...
  odisha: {
    title: "Odisha",
    heroImage:
      "https://i0.wp.com/somanytraveltales.com/wp-content/uploads/2024/04/Steps-leading-to-Jay-Vijay-Gufa-on-top-and-Cave-4-Alkapuri-Gufa-on-Right.jpg?resize=1024%2C653&ssl=1",
    description:
      "A treasure trove of majestic stone temples, pristine sandy beaches, and incredible migratory bird lake sanctuaries.",
    places: [
      {
  ...
  punjab: {
    title: "Punjab",
    heroImage:
      "https://static01.nyt.com/images/2023/09/27/multimedia/00india-punjab-01-lgbj/00india-punjab-01-lgbj-mediumSquareAt3X.jpg",
    description:
      "The heartwarming land of endless green fields, rich bhangra beats, legendary culinary experiences, and iconic golden spiritual shrines.",
    places: [
      {
        name: "Golden Temple",
  ...
  rajasthan: {
    title: "Rajasthan",
    heroImage:
      "https://www.prishindia.com/wp-content/uploads/2018/12/Jaisalmer-Desert-Safari-6_1438939406-1200x707.jpg",
    description:
      "Embark on a majestic journey through Rajasthan, where timeless fortresses rise out of glowing sand dunes. Immerse yourself in rich history, vibrant folk arts, and opulent palaces.",
    places: [
      {
  ...
  sikkim: {
    ...
    heroImage:
      "https://images.unsplash.com/photo-1589308078059-be1415eab4c3?auto=format&fit=crop&w=1920&q=80",
    description:
      "A sparkling clean mountain eco-haven overseen by the massive Mt. Khangchendzonga, rich with high-altitude alpine lakes.",
    places: [
      {
  ...
  "tamil-nadu": {
    title: "Tamil Nadu",
    heroImage:
      "https://images.unsplash.com/photo-1580137189272-c9379f8864fd?auto=format&fit=crop&w=1920&q=80",
    description:
      "Immerse yourself in towering Dravidian temple gateways, classical Bharatanatyam heritage, and relaxing mist-covered mountain hill stations.",
    places: [
      {
  ...
  telangana: {
    title: "Telangana",
    heroImage:
      "https://images.unsplash.com/photo-1604999333679-b86d54738315?auto=format&fit=crop&w=1920&q=80",
    description:
      "A state rich in heritage, featuring massive historic fortresses, complex architectural monuments, and dynamic modern information technology clusters.",
    places: [
      {
  ...
  tripura: {
    ...
    description:
      "An elegant royal frontier state hosting beautiful lake palaces, hills, and massive ancient rock-cut stone relief art pieces.",
    places: [
      {
  ...
  "uttar-pradesh": {
    ...
    description:
      "The deep epicenter of Indian spiritualism, architecture, and history, split alongside the sacred banks of the Ganges and Yamuna rivers.",
    places: [
      {
        name: "Agra",
  ...
  uttarakhand: {
    title: "Uttarakhand",
    heroImage:
      "https://www.uttarakhandtourism.gov.in/assets/media/GodGrace.jpg",
    description:
      "A spectacular Himalayan state offering mountain adventure river rafting, expansive glacial trails, and deep holy pilgrimage hubs.",
    places: [
      {
  ...
  "west-bengal": {
    title: "West Bengal",
    heroImage:
      "https://images.unsplash.com/photo-1558431382-27e303142255?auto=format&fit=crop&w=1920&q=80",
    description:
      "Blends rich artistic literary heritages, historic colonial architectures, misty mountain tea ridges, and the massive wild mangrove swamps.",
    places: [
      {
