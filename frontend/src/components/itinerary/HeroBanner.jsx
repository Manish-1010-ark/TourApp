  ...
  return (
    <div className="relative rounded-3xl overflow-hidden mb-6">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #0ea5e9 0%, #38bdf8 45%, #f59e0b 100%)",
        }}
      >
        <svg
        ...
        >
          <path
            d="M0 200 L0 120 L120 40 L220 120 L320 60 L420 130 L520 30 L620 110 L720 70 L800 120 L800 200 Z"
            fill="white"
          />
        </svg>
        <svg
        ...
        >
          <path
            d="M0 140 L0 90 L150 20 L300 90 L450 40 L600 100 L800 50 L800 140 Z"
            fill="white"
          />
        </svg>
      ...
      <div className="absolute inset-x-4 sm:inset-x-8 bottom-4 sm:bottom-8">
        <div className="bg-white/20 backdrop-blur-md border border-white/30 rounded-2xl p-5 sm:p-7 max-w-2xl">
          ...
          <p className="text-white/90 font-body text-sm sm:text-base mb-4 max-w-lg">
            A thoughtfully planned journey covering the best attractions, local
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {travelMode && (
              <Badge>
                ...
                {MODE_LABELS[travelMode] ?? travelMode}
              </Badge>
            )}
            <Badge>
              <CalendarIcon className="w-3.5 h-3.5" /> {days}{" "}
              {days === 1 ? "Day" : "Days"}
            </Badge>
            {budgetLabel && (
              <Badge>
