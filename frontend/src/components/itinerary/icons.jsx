...
export function RupeeIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <path
        d="M7 5h10M7 9h10M7 5c4 0 6 1.3 6 4s-2 4-6 4h-1l7 6"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function TipIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <path
        d="M9 18h6M10 21h4M12 3a6 6 0 00-3.5 10.9c.4.3.6.8.6 1.3v.3h5.8v-.3c0-.5.2-1 .6-1.3A6 6 0 0012 3z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const ACTIVITY_ICON_PATHS = {
  food: (
    <path
      d="M6 3v7a3 3 0 003 3v8M6 3v7M9 3v7M12 3v9a3 3 0 003 3v6M15 3c-2 1-2 4-2 6s0 3 2 3"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinecap="round"
      strokeLinejoin="round"
  ...
  hotel: (
    <path
      d="M4 20V6a1 1 0 011-1h6a1 1 0 011 1v14M12 20V10h7a1 1 0 011 1v9M4 20h16M7 8h1M7 11h1M7 14h1"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinecap="round"
      strokeLinejoin="round"
  ...
  travel: (
    <path
      d="M3 12l7-1.5L14 4l2 1-3 6.5 5.5-1 2 1.5-6 3-3 4-1.5-.5 1-4L7 15l-2 1-1-1 1.5-2z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
  ...
  shopping: (
    <path
      d="M6 8h12l-1 12H7L6 8zM9 8a3 3 0 016 0"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinecap="round"
      strokeLinejoin="round"
  ...
  nature: (
    <path
      d="M12 3l4 6h-2.5l3.5 6h-3l2 5H8l2-5H7l3.5-6H8z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
  ...
  adventure: (
    <path
      d="M4 20l6-14 2 4 2-4 6 14M8 20l4-9 4 9"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinecap="round"
      strokeLinejoin="round"
  ...
  relaxation: (
    <path
      d="M4 17c2-4 5-6 8-6s6 2 8 6M6 17a6 6 0 0112 0"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinecap="round"
    />
  ...
  photography: (
    <path
      d="M4 8h3l1.5-2h7L17 8h3a1 1 0 011 1v9a1 1 0 01-1 1H4a1 1 0 01-1-1V9a1 1 0 011-1z M12 17a3.5 3.5 0 100-7 3.5 3.5 0 000 7z"
      stroke="currentColor"
      strokeWidth="1.6"
      strokeLinejoin="round"
    />
  ...
  beach: (
    <path
      d="M3 21c4-1 6-1 9 0s5 1 9 0M12 3a6 6 0 00-6 9M12 3a6 6 0 016 9M3 15l18-6"
      stroke="currentColor"
      strokeWidth="1.6"
      strokeLinecap="round"
      strokeLinejoin="round"
