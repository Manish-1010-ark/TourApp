  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/itinerary">
                <button className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-pink-600 text-white rounded-full hover:shadow-lg hover:scale-105 transition-all font-medium">
                  Create Itinerary
                </button>
              </Link>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-slate-200">
              <div className="flex flex-col space-y-4">
                ...
                <Link href="/itinerary">
                  <button className="w-full px-6 py-2.5 bg-gradient-to-r from-orange-500 to-pink-600 text-white rounded-full hover:shadow-lg transition font-medium">
                    Create Itinerary
                  </button>
                </Link>
              </div>
      ...
      <section className="relative pt-24 pb-20 px-4 overflow-hidden min-h-[90vh] flex items-center">
        {/* Background - You can add your image here */}
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              {/* Placeholder for hero image - you can add your image here */}
              <div className="relative aspect-[4/5] bg-gradient-to-br from-orange-200 to-purple-300 rounded-3xl shadow-2xl">
                <div className="absolute inset-0 flex items-center justify-center text-slate-500">
                  {/* Your hero image will go here */}
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-orange-400 to-pink-500 rounded-xl"></div>
                  <div>
      ...
      {/* Newsletter */}
      <section className="py-20 px-4 bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              <button
                ...
                className="px-8 py-4 bg-white text-pink-600 rounded-full font-semibold hover:bg-slate-100 transition flex items-center justify-center space-x-2 shadow-lg"
              >
                {subscribed ? (
                  <>
      ...
      <footer className="bg-slate-900 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-orange-500 hover:to-pink-600 transition"
                >
          ...
          <div className="border-t border-slate-800 pt-8 text-center text-slate-400">
            <p>
              &copy; 2025 Wanderly India. All rights reserved. Made with ❤️ for
              Indian travelers.
            </p>
          </div>
        </div>
